...
export default function AddModalCategory({ visible, handleCloseAddModal, addCategory, setLoading }) {
                    ...
                    <div className="card-body">
                        <div className="row g-3">
                            <div className="col-md-6">
                                <label htmlFor="categoryName" className="form-label">Име на категория</label>
                                <input type="phone" className="form-control" id="categoryName" name="categoryName" value={formData.categoryName} onChange={handleChange} />
                            </div>
                            {/* <div className="col-md-6">
